...
float ex_get_multiclass_probability(example_ptr ec, uint32_t i) { return ec->pred.scalars[i]; }
...
{ // This will enable user-defined docstrings and python signatures,
  ...
  .def("get_multiclass_probability", &ex_get_multiclass_probability, "Assuming an OAA label type and that probability has been set, get the probability of label i")
